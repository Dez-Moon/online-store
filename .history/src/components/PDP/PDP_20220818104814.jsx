...
import { GET_PRODUCT } from "../../Сonstants for server requests/constants";
...
class PDP extends React.Component {
  ...
  componentDidMount() {
    const categories = JSON.stringify(getProducts);
    ...
    apolloClient.query({ query: GET_PRODUCT(id) }).then((res) => {
      this.setState({
        product: res.data.product,
      });

      res.data.product.attributes.forEach((attribut) => {
